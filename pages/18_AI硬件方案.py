...
st.write("一些嵌入式设备使用与桌面/数据中心设备类似的架构。使用昇腾方案的有香橙派AI Pro系列，性价比低一些，虽然昇腾生态相对完善但该产品教程较少，其它应用可能因用户和社区支持较少导致难以部署。英伟达的边缘计算产品如Jetson Nano价格同样偏高，性价比不如显卡。这两种由于其它同架构产品的生态，虽然部署可能遇到问题但最终能支持的模型多不少。")
