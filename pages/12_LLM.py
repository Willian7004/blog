...
st.write("多模态模型开源处理图片。对于非推理模型，闭源模型中Claude3.5 Sonnet表现最好，开源模型中Qwen2.5 VL 32B表现最好，Mistral Small3.1适用于16g显存。对于推理模型，闭源模型中o1表现最好，开源模型中Skywork R1V 38B语言任务有优势，适合使用多模态作为辅助输入。以下是几个模型的对比")
