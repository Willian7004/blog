...
st.write("旗舰模型参数量较大，运行成本较高但可完成的任务也较多。闭源模型中，Grok3总体效果最好，Gemini2.0Flash有成本优势，Claude3.7 Sonnet在编程上有优势。开源模型中，Deepseek v3 0324性能最好，Llama4 Maverick有性价比优势并且同时适用于多模态任务。")

st.subheader("2.多模态模型", divider=True)
st.write("多模态模型开源处理图片。对于非推理模型，闭源模型中Claude3.5 Sonnet表现最好，开源模型中Qwen2.5 VL 32B表现最好。对于推理模型，闭源模型中o1表现最好，开源模型中Skywork R1V 38B语言任务有优势，适合使用多模态作为辅助输入。以下是几个模型的对比")
