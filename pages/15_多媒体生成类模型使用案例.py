...
st.write("https://william7004-gallery.streamlit.app/AI%E5%9B%BE%E7%89%87 展示了使用Hunyuan Video生成的图片，复用了以前使用Flux.1的提示词并添加了一些新的内容。")
st.write("使用Sana_1600M_2kpx生成的图片如下：")
st.image("files/sana_1.jpg")
st.image("files/sana_2.jpg")
col1, col2 = st.columns(2)
with col1:
    st.image("files/sana_3.jpg")
with col2:
    st.image("files/sana_4.jpg")
