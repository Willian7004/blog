...
st.write("嵌入式设备中，通常使用NPU运行AI应用。瑞芯微的低端型号主要支持RNN，对LLM支持较好的有RK3576和RK3588，官方以及一些产品提供较为完整的资料。地平线旭日系列算力性价比高一些，资料也较为完整但GPU设计不适合桌面应用，建议用于边缘计算。使用昇腾方案的有香橙派AI Pro系列，性价比低一些，虽然昇腾生态相对完善但该产品教程较少，其它应用可能因用户和社区支持较少导致难以部署。英伟达的边缘计算产品如Jetson Nano价格同样偏高，性价比不如显卡。")
