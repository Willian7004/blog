...
st.write("多模态模型开源处理图片。对于非推理模型，闭源模型中Claude3.5 Sonnet表现最好，开源模型中Qwen2.5 VL 32B表现最好。对于推理模型，闭源模型中o1表现最好，开源模型中Skywork R1V 38B适合使用多模态作为辅助输入的语言任务，Kimi VL Thinking适合多模态任务且配置要求较低。以下是几个模型的对比")
